...
import { FaHtml5, FaCss3Alt, FaJs, FaReact, FaNodeJs, FaFigma, FaDocker, FaJava, FaAws, FaAngular } from 'react-icons/fa';
import { SiTypescript, SiTailwindcss, SiSpringboot, SiDatabricks, SiPython } from 'react-icons/si';
...
const skillsData: Skill[] = [
  { name: 'Java', icon: <FaJava />, href: 'https://developer.mozilla.org/docs/Web/Java', color: 'text-red-500' },
  { name: 'Spring Boot', icon: <SiSpringboot />, href: 'https://developer.mozilla.org/docs/Web/Springboot', color: 'text-green-500'},
  { name: 'AWS', icon: <FaAws />, href: 'https://developer.mozilla.org/docs/Web/AWS', color: 'text-blue-900' },
  { name: 'Databricks', icon: <SiDatabricks />, href: 'https://developer.mozilla.org/docs/Web/Databricks', color: 'text-red-700' },
  { name: 'Azure', icon: <VscAzure />, href: 'https://developer.mozilla.org/docs/Web/Azure', color: 'text-blue-700' },
  { name: 'Angular', icon: <FaAngular />, href: 'https://developer.mozilla.org/docs/Web/Angular', color: 'text-red-700' },
  { name: 'Python', icon: <SiPython />, href: 'https://developer.mozilla.org/docs/Web/Python', color: 'text-yellow-600' },
