        ...
        <div className="grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          ...
          <div className="space-y-6 bg-white/70 backdrop-blur-lg p-8 rounded-3xl shadow-[0_10px_40px_rgba(199,238,255,0.25)] border border-white/60 animate-[float_7s_ease-in-out_infinite]">
            ...
            <p className="text-lg text-text-dark/85 leading-relaxed font-nunito">
              Desenvolvedora de Software Fullstack atualmente mais inclinada ao Backend e Dados.
              <p> 
              Atuo na construção de microsserviços escaláveis, pipelines de dados e no refinamento lógico de Inteligências Artificiais. 
              </p> <p>
              Sou apaixonada por unir código limpo, segurança e alta performance.
              </p>
            </p>

            <p className="text-lg text-text-dark/85 leading-relaxed font-nunito">
              Amo transformar ideias em produtos reais com <span className="font-semibold text-purple-500">Java, TypeScript, Javascript e Python</span>.              
            </p>
